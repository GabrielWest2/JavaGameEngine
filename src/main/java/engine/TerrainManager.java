...
public class TerrainManager {
    ...
    public static void init(){
        splatmap = TextureLoader.loadTexture(
                "Terrain/Terrain_splatmap_0.png");
        t1 = TextureLoader.loadTexture(
                "Terrain/Texture_Grass_Diffuse.png");
        t2 = TextureLoader.loadTexture(
                "Terrain/Texture_Dirt_Diffuse.png");
        t3 = TextureLoader.loadTexture(
                "Terrain/Texture_Gravel_Diffuse.png");
        t4 = TextureLoader.loadTexture(
                "Terrain/Texture_Rock_Diffuse.png");

        try {
            heightmap = ImageIO.read(new File(
        ...
        terrainChunks.put(new Vector2i(0, 0),
                new TerrainChunk(0, 0, 1));
    ...
    public static void regenerateChunks(int lod){
        ...
        terrainChunks.put(new Vector2i(0, 0),
                new TerrainChunk(0, 0, lod));

        System.out.println("Generated chunks; took " +
